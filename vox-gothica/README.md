...
M5 toolchain: `purga`, `lustro`, `censura`, `speculum`, `codex`. Sample apps in `applicata/` (Cogitator Arithmetica, Auspex Impietatis, Census Mortis). Not yet: full LSP server, full conformance ch.01–10.
